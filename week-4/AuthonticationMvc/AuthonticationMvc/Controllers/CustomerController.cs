...
using AuthonticationMvc.ViewModels;
using AuthonticationMvc.Views.ViewModel;
using System;
...
namespace AuthonticationMvc.Controllers
{
    public class CustomerController : Controller
    {
        ...
        private AuthonticationMvcContext _context;

        public CustomerController() 
        {
            _context = new AuthonticationMvcContext();
        }
