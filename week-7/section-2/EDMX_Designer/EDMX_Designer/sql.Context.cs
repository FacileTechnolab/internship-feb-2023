...
namespace EDMX_Designer
{
    ...
    public partial class skilaEntities2 : DbContext
    {
        public skilaEntities2()
            : base("name=skilaEntities2")
        {
        }
        ...
        [DbFunction("skilaEntities2", "funcGetAuthorCourses")]
        public virtual IQueryable<funcGetAuthorCourses_Result> funcGetAuthorCourses(Nullable<int> authorID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<funcGetAuthorCourses_Result>("[skilaEntities2].[funcGetAuthorCourses](@AuthorID)", authorIDParameter);
        }

        public virtual ObjectResult<GetCourses_Result> GetCourses() => ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetCourses_Result>("GetCourses");
