...
{
    public abstract class FirstCrudPojectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FirstCrudPojectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FirstCrudPojectWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<FirstCrudPojectDbContext> action)
        {
            using (var context = IocManager.Resolve<FirstCrudPojectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<FirstCrudPojectDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<FirstCrudPojectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FirstCrudPojectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FirstCrudPojectDbContext, Task<T>> func)
        {
            T result;
