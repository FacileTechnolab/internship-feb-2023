...
@Injectable()
export class EventAppServicesServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    create(body: CreateEventInput | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/EventAppServices/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/EventAppServices/Delete?";
        if (id === null)
     ...
     * @return Success
     */
    getEventByID(id: number | undefined): Observable<GetEventOutput> {
        let url_ = this.baseUrl + "/api/services/app/EventAppServices/GetEventByID?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<GetEventOutput>;
                }
            } else
                return _observableThrow(response_) as any as Observable<GetEventOutput>;
        }));
    }

    protected processGetEventByID(response: HttpResponseBase): Observable<GetEventOutput> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetEventOutput.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    listAll(): Observable<GetEventOutput[]> {
        let url_ = this.baseUrl + "/api/services/app/EventAppServices/ListAll";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processListAll(response: HttpResponseBase): Observable<GetEventOutput[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200.push(GetEventOutput.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
     ...
     * @return Success
     */
    update(body: UpdateEventInput | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/EventAppServices/Update";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getEvent(filter: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<GetEventOutputPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/EventAppServices/GetEvent?";
        if (filter === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<GetEventOutputPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<GetEventOutputPagedResultDto>;
        }));
    }

    protected processGetEvent(response: HttpResponseBase): Observable<GetEventOutputPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetEventOutputPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
@Injectable()
export class TicketAppServicesServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    create(body: CreateTicketInput | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/TicketAppServices/Create";
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/TicketAppServices/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
     ...
     * @return Success
     */
    getTicketById(id: number | undefined): Observable<GetTicketOutput> {
        let url_ = this.baseUrl + "/api/services/app/TicketAppServices/GetTicketById?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetTicketById(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetTicketById(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<GetTicketOutput>;
                }
            } else
                return _observableThrow(response_) as any as Observable<GetTicketOutput>;
        }));
    }

    protected processGetTicketById(response: HttpResponseBase): Observable<GetTicketOutput> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetTicketOutput.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    listAll(): Observable<GetTicketOutput[]> {
        let url_ = this.baseUrl + "/api/services/app/TicketAppServices/ListAll";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processListAll(response: HttpResponseBase): Observable<GetTicketOutput[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200.push(GetTicketOutput.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
     ...
     * @return Success
     */
    update(body: UpdateTicketInput | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/TicketAppServices/Update";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getTicket(filter: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<GetTicketOutputPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/TicketAppServices/GetTicket?";
        if (filter === null)
            throw new Error("The parameter 'filter' cannot be null.");
        else if (filter !== undefined)
            url_ += "Filter=" + encodeURIComponent("" + filter) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<GetTicketOutputPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<GetTicketOutputPagedResultDto>;
        }));
    }

    protected processGetTicket(response: HttpResponseBase): Observable<GetTicketOutputPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetTicketOutputPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export class CreateTicketInput implements ICreateTicketInput {
    ...
    constructor(data?: ICreateTicketInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateTicketInput {
        data = typeof data === 'object' ? data : {};
        let result = new CreateTicketInput();
        result.init(data);
        return result;
    }
...
export class GetEventOutput implements IGetEventOutput {
    id: number;
    name: string | undefined;
    description: string | undefined;
    eventDate: moment.Moment;
    ...
    constructor(data?: IGetEventOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): GetEventOutput {
        data = typeof data === 'object' ? data : {};
        let result = new GetEventOutput();
        result.init(data);
        return result;
    }
...
export class GetEventOutputPagedResultDto implements IGetEventOutputPagedResultDto {
    items: GetEventOutput[] | undefined;
    totalCount: number;

    constructor(data?: IGetEventOutputPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items.push(GetEventOutput.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): GetEventOutputPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetEventOutputPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): GetEventOutputPagedResultDto {
        const json = this.toJSON();
        let result = new GetEventOutputPagedResultDto();
        result.init(json);
        return result;
...
export interface IGetEventOutputPagedResultDto {
    items: GetEventOutput[] | undefined;
    totalCount: number;
}
...
export class GetTicketOutput implements IGetTicketOutput {
    id: number;
    ticketHolderName: string | undefined;
    discount: number;
    eventId: number;
    ...
    static fromJS(data: any): GetTicketOutput {
        data = typeof data === 'object' ? data : {};
        let result = new GetTicketOutput();
        result.init(data);
        return result;
    }
...
export class GetTicketOutputPagedResultDto implements IGetTicketOutputPagedResultDto {
    items: GetTicketOutput[] | undefined;
    totalCount: number;

    constructor(data?: IGetTicketOutputPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items.push(GetTicketOutput.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): GetTicketOutputPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetTicketOutputPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): GetTicketOutputPagedResultDto {
        const json = this.toJSON();
        let result = new GetTicketOutputPagedResultDto();
        result.init(json);
        return result;
...
export interface IGetTicketOutputPagedResultDto {
    items: GetTicketOutput[] | undefined;
    totalCount: number;
}
...
export class UpdateEventInput implements IUpdateEventInput {
    id: number;
    name: string | undefined;
    description: string | undefined;
    eventDate: moment.Moment;
    ...
    constructor(data?: IUpdateEventInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdateEventInput {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateEventInput();
        result.init(data);
        return result;
    }
...
export class UpdateTicketInput implements IUpdateTicketInput {
    ...
    constructor(data?: IUpdateTicketInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdateTicketInput {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateTicketInput();
        result.init(data);
        return result;
    }
