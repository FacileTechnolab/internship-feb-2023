...
namespace Krishika.Project.Migrations
{
    ...
    [Migration("20230630195418_Added_ProjectResources_Table")]
    partial class Added_ProjectResources_Table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Krishika.Project.Modal.ProjectResource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Krishika.Project.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Krishika.Project.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Krishika.Project.Modal.ProjectResource", b =>
                {
                    b.HasOne("Krishika.Project.Modal.Project", "Project")
                        .WithMany()
