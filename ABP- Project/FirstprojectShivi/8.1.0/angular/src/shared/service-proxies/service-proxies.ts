...
export class OrderServiceProxy {
     ...
     * @return Success
     */
    create(body: CreateOrderInput | undefined): Observable<void> {
     ...
     * @return Success
     */
    getOrderById(id: number | undefined): Observable<GetOrderOutput> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<GetOrderOutput>;
                }
            } else
                return _observableThrow(response_) as any as Observable<GetOrderOutput>;
        }));
    }

    protected processGetOrderById(response: HttpResponseBase): Observable<GetOrderOutput> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetOrderOutput.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    listAll(): Observable<GetOrderOutput[]> {
        let url_ = this.baseUrl + "/api/services/app/Order/ListAll";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processListAll(response: HttpResponseBase): Observable<GetOrderOutput[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200.push(GetOrderOutput.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
...
export class RestaurantServiceProxy {
     ...
     * @return Success
     */
    create(body: CreateRestaurantInput | undefined): Observable<void> {
    ...
    getRestaurantById(id: number | undefined): Observable<GetRestaurantOutput> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetRestaurantById(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetRestaurantById(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<GetRestaurantOutput>;
                }
            } else
                return _observableThrow(response_) as any as Observable<GetRestaurantOutput>;
        }));
    }

    protected processGetRestaurantById(response: HttpResponseBase): Observable<GetRestaurantOutput> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetRestaurantOutput.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    listAll(): Observable<GetRestaurantOutput[]> {
        let url_ = this.baseUrl + "/api/services/app/Restaurant/ListAll";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processListAll(response: HttpResponseBase): Observable<GetRestaurantOutput[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200.push(GetRestaurantOutput.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
     ...
     * @return Success
     */
    update(body: UpdateRestaurantInput | undefined): Observable<void> {
    ...
    getRestaurants(filter: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<GetRestaurantOutputPagedResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetRestaurants(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetRestaurants(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<GetRestaurantOutputPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<GetRestaurantOutputPagedResultDto>;
        }));
    }

    protected processGetRestaurants(response: HttpResponseBase): Observable<GetRestaurantOutputPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = GetRestaurantOutputPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export class CreateRestaurantInput implements ICreateRestaurantInput {
    ...
    static fromJS(data: any): CreateRestaurantInput {
        data = typeof data === 'object' ? data : {};
        let result = new CreateRestaurantInput();
        result.init(data);
        return result;
    }
...
export class GetOrderOutput implements IGetOrderOutput {
    ...
    static fromJS(data: any): GetOrderOutput {
        data = typeof data === 'object' ? data : {};
        let result = new GetOrderOutput();
        result.init(data);
        return result;
    }
...
export class GetRestaurantOutput implements IGetRestaurantOutput {
    ...
    static fromJS(data: any): GetRestaurantOutput {
        data = typeof data === 'object' ? data : {};
        let result = new GetRestaurantOutput();
        result.init(data);
        return result;
    }
...
export interface IGetRestaurantOutput {
    id: number;
    name: string | undefined;
    location: string | undefined;
    openingTime: moment.Moment | undefined;
...
export class GetRestaurantOutputPagedResultDto implements IGetRestaurantOutputPagedResultDto {
    items: GetRestaurantOutput[] | undefined;
    totalCount: number;

    constructor(data?: IGetRestaurantOutputPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items.push(GetRestaurantOutput.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): GetRestaurantOutputPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new GetRestaurantOutputPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): GetRestaurantOutputPagedResultDto {
        const json = this.toJSON();
        let result = new GetRestaurantOutputPagedResultDto();
        result.init(json);
        return result;
...
export interface IGetRestaurantOutputPagedResultDto {
    items: GetRestaurantOutput[] | undefined;
    totalCount: number;
}
...
export class UpdateRestaurantInput implements IUpdateRestaurantInput {
    id: number;
    name: string | undefined;
    location: string | undefined;
    openingTime: moment.Moment | undefined;
    ...
    static fromJS(data: any): UpdateRestaurantInput {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateRestaurantInput();
        result.init(data);
        return result;
    }
