...
{
    public abstract class FirstprojectShiviWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FirstprojectShiviWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FirstprojectShiviWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FirstprojectShiviDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FirstprojectShiviDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FirstprojectShiviDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FirstprojectShiviDbContext, Task<T>> func)
        {
            T result;
